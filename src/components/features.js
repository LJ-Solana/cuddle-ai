...
export default function Features() {
  return (
    <ScrollView style={{height: hp(60)}} bounces={false} showsVerticalScrollIndicator={false} className="space-y-4">
        <Text style={{fontSize: wp(6.5)}} className="font-semibold text-center text-feature3">Cuddle can help with:</Text>
        ...
        <View className="bg-feature3 p-4 rounded-xl space-y-2">
            <View className="flex-row items-center space-x-1">
                <Text style={{ fontSize: hp(2.5)}}>👩‍🍼</Text>
                <Text style={{fontSize: wp(4.8)}} className="font-semibold text-white">Bath & Changing</Text>
            </View>
